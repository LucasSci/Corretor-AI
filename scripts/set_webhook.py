...
NOME_INSTANCIA = os.getenv(\'EVOLUTION_INSTANCE\', \'BotRiva1\') # ou CorretorRiva01
...
url = f"{os.getenv(\'URL_EVOLUTION\', \'http://localhost:8080\')}/webhook/set/{NOME_INSTANCIA}"

headers = {
    "apikey": os.getenv(\'API_KEY_EVOLUTION\', \'lucas_senha_123\'),
