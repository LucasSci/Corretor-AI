...
# Mantenho as variáveis de ambiente com defaults seguros e não hardcoded keys sensíveis
...
DEFAULT_URL_EVOLUTION = os.getenv("URL_EVOLUTION", "")
DEFAULT_API_KEY_EVOLUTION = os.getenv("API_KEY_EVOLUTION", "")
DEFAULT_EVOLUTION_INSTANCE = os.getenv("EVOLUTION_INSTANCE", "")
